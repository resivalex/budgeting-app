...
The application uploads ZIP archives of both databases to a designated Google Drive folder on a configurable schedule, ensuring data can be restored from cloud storage in case of local data loss.
