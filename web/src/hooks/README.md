...
| `useSyncDomain`            | `SyncDomain`            | Sequential pull scheduling, push guard, retry logic, sync status atom, loading state |
| `useSettingsDomain`        | `SettingsDomain`        | Load category/account settings from PouchDB into atoms                               |
