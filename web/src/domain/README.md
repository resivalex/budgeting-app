...
| `TransactionFilterDomain` | Filters transactions by multiple criteria (matching `account_from`/`account_to` for accounts, `bucket_from`/`bucket_to` for buckets); supports cross-layout (EN/RU keyboard) matching.                                   |
