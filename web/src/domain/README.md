...
| `BudgetsDomain`           | Loads spending limits from CouchDB; computes budget totals with multi-currency conversion; generates synthetic summary and total budget entries; writes budget item updates directly to CouchDB                                                 |
